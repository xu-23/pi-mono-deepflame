...
For TypeScript definitions in your project, inspect `node_modules/@lunezhang/pi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@lunezhang/pi-coding-agent";
